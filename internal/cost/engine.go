...
// Cache-read is ~0.1x input on the Anthropic tier and 0.5x input on the
// OpenAI gpt-4o family; 5-minute cache-write is ~1.25x input. Values
...
func DefaultPrices() Prices {
	return Prices{
		...
		"openai": {
			"gpt-4o":      {InputPer1M: 2.50, CachedInputPer1M: 1.25, CacheWritePer1M: 3.125, OutputPer1M: 10.00},
